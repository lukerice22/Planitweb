  ...
  return (
    <html lang="en">
      <head>
        ...
        <title>Planit — Plan smarter. Pin everywhere.</title>
        <meta
          name="description"
          content="Planit is a simple travel app to pin places, plan trips, and save memories. Add from photos, explore on a bright map, and sync across devices."
        />

        {/* OpenGraph + Twitter Card meta tags */}
        <meta property="og:title" content="Planit — Plan smarter. Pin everywhere." />
        <meta
        ...
        <meta name="twitter:title" content="Planit — Plan smarter. Pin everywhere." />
        <meta
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              ...
              <div className="hidden md:flex items-center space-x-8">
                ...
                <a href="#screens" className="text-gray-600 hover:text-primary transition-colors">
                  Screens
                </a>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="text-center lg:text-left">
                <h1 className="text-4xl lg:text-6xl font-bold text-dark mb-6 leading-tight">
                  Plan smarter.
                  <br />
                  <span className="text-primary">Pin everywhere.</span>
                </h1>
                <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                  Save wishlist spots, plan amazing trips, and capture memories with the simplest travel app you'll ever
                  use.
                </p>
                ...
                <div className="flex items-center justify-center lg:justify-start gap-4">
                  <img
                    src="{{QR_CODE_PNG}}"
                    alt="QR Code to download Planit"
                    className="w-16 h-16 cursor-pointer hover:scale-105 transition-transform"
                    id="qr-code"
                    onError={(e) => (e.currentTarget.style.display = "none")}
                  />
                  <span className="text-sm text-gray-600">Scan to install</span>
                </div>
              </div>
              <div className="relative">
                <div className="relative mx-auto w-64 h-[500px] bg-gray-900 rounded-[3rem] p-2 shadow-2xl">
                  <div className="w-full h-full bg-white rounded-[2.5rem] overflow-hidden relative">
                    <div id="screenshot-slider" className="w-full h-full relative">
                      <img
                        src="/mobile-app-home-screen-with-map.png"
                        alt="Planit Home Screen"
                        className="screenshot-slide w-full h-full object-cover absolute inset-0 opacity-100 transition-opacity duration-500"
                      />
                      <img
                        src="/mobile-app-pins-list-screen.png"
                        alt="Planit Pins Screen"
                        className="screenshot-slide w-full h-full object-cover absolute inset-0 opacity-0 transition-opacity duration-500"
                      />
                      <img
                        src="/mobile-app-trip-planning-screen.png"
                        alt="Planit Plan Screen"
                        className="screenshot-slide w-full h-full object-cover absolute inset-0 opacity-0 transition-opacity duration-500"
                      />
                    </div>
                  </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="relative mx-auto w-48 h-80 bg-gray-900 rounded-3xl p-2 mb-6">
                  <div className="w-full h-full bg-white rounded-2xl overflow-hidden">
                    <img src="/mobile-app-search-places-screen.png" alt="Search places" className="w-full h-full object-cover" />
                  </div>
                </div>
              ...
              <div className="text-center">
                <div className="relative mx-auto w-48 h-80 bg-gray-900 rounded-3xl p-2 mb-6">
                  <div className="w-full h-full bg-white rounded-2xl overflow-hidden">
                    <img src="/mobile-app-pin-locations-screen.png" alt="Pin locations" className="w-full h-full object-cover" />
                  </div>
                </div>
                <div className="w-8 h-8 bg-primary text-white rounded-full flex items-center justify-center mx-auto mb-4 text-sm font-bold">
                  2
              ...
              <div className="text-center">
                <div className="relative mx-auto w-48 h-80 bg-gray-900 rounded-3xl p-2 mb-6">
                  <div className="w-full h-full bg-white rounded-2xl overflow-hidden">
                    <img src="/mobile-app-plan-trips-screen.png" alt="Plan trips" className="w-full h-full object-cover" />
                  </div>
                </div>
                <div className="w-8 h-8 bg-primary text-white rounded-full flex items-center justify-center mx-auto mb-4 text-sm font-bold">
                  3
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              >
                <div className="relative mx-auto w-full max-w-48 aspect-[9/16] bg-gray-900 rounded-3xl p-2 shadow-lg">
                  <div className="w-full h-full bg-white rounded-2xl overflow-hidden">
                    <img src="/mobile-app-photo-journal-screen.png" alt="Photo Journal" className="w-full h-full object-cover" />
                  </div>
                </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="mb-4 md:mb-0">
                <p className="text-sm text-gray-400">&copy; 2024 Planit. All rights reserved.</p>
              </div>
        ...
        <script
          dangerouslySetInnerHTML={{
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                document.getElementById('hero-get-app').onclick = () => window.open(appLink, '_blank');
